...
import { RestaurantVisualEditor } from './RestaurantVisualEditor';
...
export const RestaurantTab: React.FC<RestaurantTabProps> = ({ config, onChange, onSubmit, isLoading }) => {
    ...
    return (
      <div className="min-h-[60vh] w-full flex flex-col items-center justify-center gap-6 bg-white/50 backdrop-blur-sm rounded-3xl border border-slate-200 shadow-sm">
        ...
        <div className="space-y-1 text-center">
          ...
          <p className="text-xs text-slate-500 font-medium">Preparando el entorno de personalización gastronómica...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
        <div className="text-left">
          <h4 className="text-sm font-bold text-slate-900">Método de Edición de Restaurante</h4>
